...
class PestListPage extends StatelessWidget {
  final List<Infos> pestExamples = [
    Infos(name: 'NA', description: 'NA.', imageUrl: 'assets/crb.jpg'),
    Infos(name: 'NA', description: 'NA', imageUrl: 'NA'),
    Infos(name: 'NA', description: 'NA.', imageUrl: 'assets/csi.jpg'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Coconut Pests')),
