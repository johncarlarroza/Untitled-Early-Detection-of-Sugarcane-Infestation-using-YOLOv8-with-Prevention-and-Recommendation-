...
class FrostyPodRotPage extends StatefulWidget {
  final Infos disease;

  const FrostyPodRotPage({super.key, required this.disease});

  @override
  State<FrostyPodRotPage> createState() => _FrostyPodRotPageState();
}

class _FrostyPodRotPageState extends State<FrostyPodRotPage> {
  int _currentIndex = 0;
