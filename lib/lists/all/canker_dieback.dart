...
class CocoaCankerDiebackPage extends StatefulWidget {
  final Infos disease;

  const CocoaCankerDiebackPage({super.key, required this.disease});

  @override
  State<CocoaCankerDiebackPage> createState() => _CocoaCankerDiebackPageState();
}

class _CocoaCankerDiebackPageState extends State<CocoaCankerDiebackPage> {
  int _currentIndex = 0;
