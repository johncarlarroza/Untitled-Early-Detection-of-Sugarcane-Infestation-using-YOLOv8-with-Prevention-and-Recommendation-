...
class ShootBorersPage extends StatefulWidget {
  final Infos pest;

  const ShootBorersPage({super.key, required this.pest});

  @override
  State<ShootBorersPage> createState() => _ShootBorersPageState();
}

class _ShootBorersPageState extends State<ShootBorersPage> {
  int _currentIndex = 0;
