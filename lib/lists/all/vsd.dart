...
class VsdPage extends StatefulWidget {
  final Infos disease;

  const VsdPage({super.key, required this.disease});

  @override
  State<VsdPage> createState() => _VsdPageState();
}

class _VsdPageState extends State<VsdPage> {
  int _currentIndex = 0;
