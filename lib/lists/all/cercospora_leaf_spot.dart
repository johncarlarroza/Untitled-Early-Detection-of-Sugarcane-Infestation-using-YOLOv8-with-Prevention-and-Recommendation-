...
class CercosporaLeafSpotPage extends StatefulWidget {
  final Infos disease;

  const CercosporaLeafSpotPage({super.key, required this.disease});

  @override
  State<CercosporaLeafSpotPage> createState() => _CercosporaLeafSpotPageState();
}

class _CercosporaLeafSpotPageState extends State<CercosporaLeafSpotPage> {
  int _currentIndex = 0;
