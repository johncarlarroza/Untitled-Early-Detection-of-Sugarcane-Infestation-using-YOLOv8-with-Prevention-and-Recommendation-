...
class PinkDiseasePage extends StatefulWidget {
  final Infos disease;

  const PinkDiseasePage({super.key, required this.disease});

  @override
  State<PinkDiseasePage> createState() => _PinkDiseasePageState();
}

class _PinkDiseasePageState extends State<PinkDiseasePage> {
  int _currentIndex = 0;
