...
class TrinitarioPage extends StatefulWidget {
  final Infos variety;

  const TrinitarioPage({super.key, required this.variety});

  @override
  State<TrinitarioPage> createState() => _TrinitarioPageState();
}

class _TrinitarioPageState extends State<TrinitarioPage> {
  int _currentIndex = 0;
