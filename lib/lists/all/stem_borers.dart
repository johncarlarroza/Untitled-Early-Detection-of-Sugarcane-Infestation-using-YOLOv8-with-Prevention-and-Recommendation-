...
class StemBorersPage extends StatefulWidget {
  final Infos pest;

  const StemBorersPage({super.key, required this.pest});

  @override
  State<StemBorersPage> createState() => _StemBorersPageState();
}

class _StemBorersPageState extends State<StemBorersPage> {
  int _currentIndex = 0;
