...
class ForasteroPage extends StatefulWidget {
  final Infos variety;

  const ForasteroPage({super.key, required this.variety});

  @override
  State<ForasteroPage> createState() => _ForasteroPageState();
}

class _ForasteroPageState extends State<ForasteroPage> {
  int _currentIndex = 0;
