...
class Chemspraying extends StatefulWidget {
  final Infos mitig;

  Chemspraying({required this.mitig});

  @override
  _ChemsprayingState createState() => _ChemsprayingState();
}

class _ChemsprayingState extends State<Chemspraying> {
  int _currentIndex = 0;
