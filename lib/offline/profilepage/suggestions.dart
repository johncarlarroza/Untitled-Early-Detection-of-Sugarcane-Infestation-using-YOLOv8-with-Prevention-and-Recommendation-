...
class _MyWidgetState extends State<Suggestions> {
  ...
  final CollectionReference myItems =
      FirebaseFirestore.instance.collection("Puser"); // collection name
      ...
      builder: (BuildContext context) {
        return myDialogBox(
            ...
            onPressed: () {
              ...
              Navigator.pop(
                  context); // terminate the dialog after storing the imems
            });
      },
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              commonTextField("eg. Developer", "Enter your position",
