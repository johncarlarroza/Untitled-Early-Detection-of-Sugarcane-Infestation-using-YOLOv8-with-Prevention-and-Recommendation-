...
import 'package:early_application_1/offline/pests/coconut_leaf_beetle.dart';
import 'package:early_application_1/offline/pests/coconut_rhino_beetle.dart';
import 'package:early_application_1/offline/pests/coconut_scale_insect.dart';
...
class PestListPage extends StatelessWidget {
  final List<Infos> pestExamples = [
    Infos(
      ...
      description: 'A beetle that bores into the crowns of coconut palms.',
      imageUrl: 'assets/crb.jpg',
    ),
    Infos(
      name: 'Coconut Hispine Beetle',
      description: 'A beetle that feeds on the leaves of coconut palms.',
      imageUrl: 'assets/clb.jpg',
    ),
    Infos(
      name: 'Coconut Scale Insect',
      description: 'An insect that sucks sap from coconut palms.',
