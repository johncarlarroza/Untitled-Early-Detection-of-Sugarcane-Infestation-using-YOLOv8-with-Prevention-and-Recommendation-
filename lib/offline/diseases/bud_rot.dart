...
class BudRotPage extends StatefulWidget {
  final Infos disease;

  BudRotPage({required this.disease});

  @override
  _BudRotPageState createState() => _BudRotPageState();
}

class _BudRotPageState extends State<BudRotPage> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      ...
      'assets/budrot2.jpg', // Replace with actual image paths
