...
class _HomePageState extends State<HomePage> {
  ...
  final List<Widget> _pages = [
    ...
    const OffCamera(), // Camera page content
...
class HomeContent extends StatelessWidget {
  final List<Infos> pests = [
    Infos(
      ...
      description: 'Learn about various pests that affect sugarcane plants.',
    ...
    Infos(
      ...
      description: 'Different variants of sugarcane plants.',
      imageUrl: 'assets/u.png',
    ),
  ];
